--[[
  ...
  Update
    January 14th, 2021
	Author: 
	detourious @ v3rmillion.net -UI Library
    Joldezz @ vermillion.net - Remake	
--]]
local finity = {}
finity.gs = {}
...
finity.theme = {
	...
	separator_color = Color3.fromRGB(32, 32, 33),

	text_color = Color3.fromRGB(88, 228, 130),
--text_color = Color3.fromRGB(88, 228, 130, --Halloween
  
	category_button_background = Color3.fromRGB(63, 62, 65),
	category_button_border = Color3.fromRGB(72, 71, 74),

	checkbox_checked = Color3.fromRGB(88, 228, 130),
	checkbox_outer = Color3.fromRGB(37, 34, 41),
	checkbox_inner = Color3.fromRGB(37, 34, 41),

	slider_color = Color3.fromRGB(88, 228, 130),
	...
	textbox_background = Color3.fromRGB(88, 228, 130),
	...
	dropdown_background = Color3.fromRGB(88, 228, 130),
	...
	button_background = Color3.fromRGB(88, 228, 130),
